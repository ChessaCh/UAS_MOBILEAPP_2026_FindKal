...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _validatePassword(String value) {
    setState(() {
      if (value.isEmpty) {
        ...
        _passwordError = 'Password harus memiliki karakter huruf besar.';
      } else if (!RegExp(r'[a-z]').hasMatch(value)) {
        _passwordError = 'Password harus memiliki karakter huruf kecil.';
      } else if (!RegExp(r'[0-9]').hasMatch(value)) {
        _passwordError = 'Password harus memiliki angka.';
      } else if (!RegExp(r'[^A-Za-z0-9]').hasMatch(value)) {
        _passwordError = 'Password harus memiliki karakter spesial.';
      } else {
        _passwordError = null;
      }
    });
  ...
  bool get _isFormValid {
    ...
    if (password.isEmpty || 
        ...
        !RegExp(r'[^A-Za-z0-9]').hasMatch(password)) return false;
  ...
  void _onSelanjutnyaTapped() {
    ...
    if (password.isEmpty) {
      ...
      if (!RegExp(r'[A-Z]').hasMatch(password)) errors.add('Password harus memiliki karakter huruf besar.');
      if (!RegExp(r'[a-z]').hasMatch(password)) errors.add('Password harus memiliki karakter huruf kecil.');
      if (!RegExp(r'[0-9]').hasMatch(password)) errors.add('Password harus memiliki angka.');
      if (!RegExp(r'[^A-Za-z0-9]').hasMatch(password)) errors.add('Password harus memiliki karakter spesial.');
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                        color: _passwordError != null ? Colors.red : const Color(0xFF4AA5A6),
                      ),
                    ),
                  ),
                ),
              ...
              // Button Selanjutnya — only enabled after form is valid
              SizedBox(
                width: double.infinity,
                height: 48,
                child: ElevatedButton(
                  onPressed: _isFormValid ? _onSelanjutnyaTapped : null,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF4AA5A6),
                    disabledBackgroundColor: const Color(0xFFA5D1D6),
