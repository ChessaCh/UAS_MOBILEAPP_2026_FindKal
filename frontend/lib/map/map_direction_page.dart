  ...
  Future<void> _loadRoute() async {
    ...
    try {
      ...
      try {
        ...
        // Jika jarak ke tujuan lebih dari 10.000 km, gunakan default Indonesia (BSD)
        origin = LatLng(pos.latitude, pos.longitude);
        if (_haversineSimple(origin.latitude, origin.longitude, _currentDestination.latitude, _currentDestination.longitude) > 10000000) {
          origin = const LatLng(-6.3001423950968265, 106.6405338994729);
        }
      } catch (_) {
        origin = const LatLng(-6.3001423950968265, 106.6405338994729);
      }
      ...
      if (res.statusCode == 200) {
        ...
        String msg = 'Gagal mendapatkan rute (${res.statusCode})';
        try {
          final errData = jsonDecode(res.body);
          if (errData['code'] == 'NoRoute') {
            msg = 'Rute antar benua/pulau tidak didukung, atau jarak terlalu jauh.';
